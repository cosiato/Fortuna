...
export const CURRENCY_GROUPS: readonly CurrencyGroup[] = [
  ...
  { continent: 'South America', currencies: ['BRL', 'ARS', 'CLP', 'COP', 'PEN'] },
  {
    continent: 'Europe',
    currencies: ['EUR', 'GBP', 'CHF', 'SEK', 'NOK', 'DKK', 'PLN', 'CZK', 'HUF', 'RON', 'RUB', 'ISK'],
  },
  {
    continent: 'Asia',
    currencies: ['JPY', 'CNY', 'HKD', 'SGD', 'KRW', 'INR', 'IDR', 'MYR', 'THB', 'PHP', 'VND', 'TWD', 'TRY', 'AED', 'SAR', 'QAR', 'KWD', 'ILS', 'PKR'],
  },
  { continent: 'Africa', currencies: ['ZAR', 'NGN', 'EGP', 'KES', 'MAD', 'GHS', 'TZS'] },
...
const FIAT_CURRENCIES = SUPPORTED_CURRENCIES.filter((c): c is Exclude<SupportedCurrency, 'BTC'> => c !== 'BTC');
