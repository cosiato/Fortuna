...
// 63 icons from @iconify-json/solar, 198 from @iconify-json/circle-flags
...
addIcon("solar:arrow-down-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:buildings-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:code-square-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:snowflake-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:pie-chart-2-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:round-transfer-vertical-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:safe-square-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:shield-keyhole-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:trash-bin-2-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:users-group-rounded-linear", {
  width: 24,
  height: 24,
...
addIcon("solar:wallet-money-linear", {
  width: 24,
  height: 24,
...
addIcon("circle-flags:tz", {
  width: 512,
  height: 512,
  body: '<mask id="SVGuywqVbel"><circle cx="256" cy="256" r="256" fill="#fff"/></mask><g mask="url(#SVGuywqVbel)"><path fill="#ffda44" d="M399 0L0 399v45l68 68h45l399-399V68L444 0z"/><path fill="#333" d="M444 0L0 444v68h68L512 68V0z"/><path fill="#338af3" d="m113 512l399-399v399z"/><path fill="#6da544" d="M0 399V0h399z"/></g>',
})
addIcon("circle-flags:ua", {
  width: 512,
  height: 512,
